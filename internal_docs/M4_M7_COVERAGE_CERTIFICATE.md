...
| Row | Status | Reference |
|---|---|---|
| proposal.md exists, ≤1500 words (excl. diagram) | PASS | ≈1,111 prose words |
...
| container runtime only | PASS | README prerequisite |
...
| ≤300-word POC write-up (assumption→method→result→impact) | PASS | 196 words |
...
- `proposal.md`: total 1,200 words; diagram block 89 words; **prose = 1,111 words** (within hard max 1,500; within target 1,200–1,450).
- `README.md` POC write-up (bounded section "## POC write-up" → "## Material limitations"): **196 words** (within hard max 300; target margin ~180–260).
